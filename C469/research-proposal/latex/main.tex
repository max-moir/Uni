...
For the algorithm to be verified, these two properties must be shown to hold in any situation
...
This project will use a proof based approach to formally verify the chosen properties are upheld within the modelo.
It will aim to establish a formal model in Lean4, with proofs for the relevant properties.
